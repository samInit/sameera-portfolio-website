        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center justify-center">
              <div
                className={`flex items-center space-x-1 rounded-full px-2 py-2 border transition-all duration-300 ${
                  scrolled
                    ? "bg-[#121212]/90 backdrop-blur-lg border-white/10 shadow-2xl"
            ...
            <div className="md:hidden flex items-center justify-end w-full">
              <motion.button
                ...
                className={`relative p-2 rounded-lg border text-white transition-all duration-300 ${
                  scrolled
                    ? "bg-[#121212]/90 backdrop-blur-lg border-white/10 shadow-xl"
                    : "bg-white/5 backdrop-blur-md border-white/10"
                }`}
              >
                {navbarOpen ? (
          ...
          {navbarOpen && (
            <>
              ...
              <motion.div
                ...
                className="fixed top-0 right-0 bottom-0 w-64 bg-[#1a1a1a]/95 backdrop-blur-xl border-l border-white/10 z-50 md:hidden shadow-2xl"
              >
                <div className="flex flex-col h-full">
                  ...
                  <div className="p-6 border-t border-white/10">
                    <div className="flex items-center justify-center gap-4">
                      ...
                      <a
                        href="mailto:kusalasameera@gmail.com"
                        className="p-2 rounded-lg bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-white/10 transition-colors"
                      >
                        <svg
                          className="w-5 h-5"
